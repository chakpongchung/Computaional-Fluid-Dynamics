...
size(u_output)
%%plot(x_output,u_output,'+'); %%% done
Nodes=[];
for j=0:N_x
    for i=0:N_x
        Nodes=[Nodes;x_output(i+1) y_output(j+1)];
    end
end
...
N2=(N_x+1)^2;
u2=reshape(u_output,N2,1);
patch('Vertices',Nodes,'Faces',B,'FaceVertexCData',u2,'FaceColor','interp');